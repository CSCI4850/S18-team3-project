...
"""Change the data_path variable below to your local extraction path, arg 1 for train, 2 for test"""

data_path = "C:\\Users\Brent\Desktop\lstm"
...
if args.run_opt == 1:
    ...
    trained_model = args.data_path + "\\two-layer-lstm-medium-config-60-epoch-0p93-lr-decay-10-max-lr-final"
